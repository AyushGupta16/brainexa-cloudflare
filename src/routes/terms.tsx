    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 space-y-5 rounded-2xl bg-card p-8 ring-1 ring-border shadow-soft text-sm leading-relaxed text-muted-foreground">
          ...
          <p><strong className="text-foreground">Referral program:</strong> commissions (up to {total}% across 3 levels) are credited per our published rules. Brainexa reserves the right to update referral terms.</p>
